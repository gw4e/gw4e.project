...
@after {
	...
	this_FORMAT_COMMENT_0=RULE_FORMAT_COMMENT
	{
...
entryRuleGraphPolicies returns [EObject current=null]:
	{ newCompositeNode(grammarAccess.getGraphPoliciesRule()); }
	iv_ruleGraphPolicies=ruleGraphPolicies
	{ $current=$iv_ruleGraphPolicies.current; }
	EOF;

// Rule GraphPolicies
ruleGraphPolicies returns [EObject current=null]
@init {
	enterRule();
}
@after {
...
entryRuleModelName returns [String current=null]:
	{ newCompositeNode(grammarAccess.getModelNameRule()); }
	iv_ruleModelName=ruleModelName
	{ $current=$iv_ruleModelName.current.getText(); }
	EOF;

// Rule ModelName
ruleModelName returns [AntlrDatatypeRuleToken current=new AntlrDatatypeRuleToken()]
@init {
	enterRule();
}
@after {
...
entryRuleSeverity returns [EObject current=null]:
	{ newCompositeNode(grammarAccess.getSeverityRule()); }
	iv_ruleSeverity=ruleSeverity
	{ $current=$iv_ruleSeverity.current; }
	EOF;

// Rule Severity
ruleSeverity returns [EObject current=null]
@init {
	enterRule();
}
@after {
...
entryRulePathGeneratorStopCondition returns [EObject current=null]@init {
	...
	{ $current=$iv_rulePathGeneratorStopCondition.current; }
	EOF;
finally {
...
rulePathGeneratorStopCondition returns [EObject current=null]
@init {
	enterRule();
	HiddenTokens myHiddenTokenState = ((XtextTokenStream)input).setHiddenTokens("RULE_WS", "RULE_ML_COMMENT", "RULE_SL_COMMENT");
}
...
entryRuleAlgorithmType returns [EObject current=null]:
	{ newCompositeNode(grammarAccess.getAlgorithmTypeRule()); }
	iv_ruleAlgorithmType=ruleAlgorithmType
	{ $current=$iv_ruleAlgorithmType.current; }
	EOF;

// Rule AlgorithmType
ruleAlgorithmType returns [EObject current=null]
@init {
	enterRule();
}
@after {
...
entryRuleIntegerStopCondition returns [EObject current=null]:
	{ newCompositeNode(grammarAccess.getIntegerStopConditionRule()); }
	iv_ruleIntegerStopCondition=ruleIntegerStopCondition
	{ $current=$iv_ruleIntegerStopCondition.current; }
	EOF;

// Rule IntegerStopCondition
ruleIntegerStopCondition returns [EObject current=null]
@init {
	enterRule();
}
@after {
...
entryRulePercentageCondition returns [EObject current=null]:
	{ newCompositeNode(grammarAccess.getPercentageConditionRule()); }
	iv_rulePercentageCondition=rulePercentageCondition
	{ $current=$iv_rulePercentageCondition.current; }
	EOF;

// Rule PercentageCondition
rulePercentageCondition returns [EObject current=null]
@init {
	enterRule();
}
@after {
...
entryRuleStringCondition returns [EObject current=null]@init {
	HiddenTokens myHiddenTokenState = ((XtextTokenStream)input).setHiddenTokens("RULE_WS", "RULE_ML_COMMENT", "RULE_SL_COMMENT");
}:
...
@after {
	...
	(
		(
			(
				(
					lv_pathtype_0_0='reached_vertex'
					{
...
entryRuleGraphElement returns [EObject current=null]:
	{ newCompositeNode(grammarAccess.getGraphElementRule()); }
	iv_ruleGraphElement=ruleGraphElement
	{ $current=$iv_ruleGraphElement.current; }
	EOF;

// Rule GraphElement
ruleGraphElement returns [EObject current=null]
@init {
	enterRule();
}
@after {

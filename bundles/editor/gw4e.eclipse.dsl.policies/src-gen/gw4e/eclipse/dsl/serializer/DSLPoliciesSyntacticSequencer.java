 ...
 */
package gw4e.eclipse.dsl.serializer;
...
public class DSLPoliciesSyntacticSequencer extends AbstractSyntacticSequencer {

	protected DSLPoliciesGrammarAccess grammarAccess;
	protected AbstractElementAlias match_Model_NEWLINETerminalRuleCall_0_1_0_a;
	protected AbstractElementAlias match_Model_NEWLINETerminalRuleCall_1_a;
	protected AbstractElementAlias match_Model___NEWLINETerminalRuleCall_0_0_0_a_CommentParserRuleCall_0_0_1__q;
	protected AbstractElementAlias match_PathGeneratorStopCondition_WSTerminalRuleCall_5_a;
	 ...
	 *     (rule start) (NEWLINE* Comment)? (ambiguity) graphPolicies+=GraphPolicies
	 *     graphPolicies+=GraphPolicies (ambiguity) graphPolicies+=GraphPolicies
	 */
	protected void emit_Model_NEWLINETerminalRuleCall_0_1_0_a(EObject semanticObject, ISynNavigable transition, List<INode> nodes) {
	 ...
	 */
	protected void emit_Model_NEWLINETerminalRuleCall_1_a(EObject semanticObject, ISynNavigable transition, List<INode> nodes) {
		acceptNodes(transition, nodes);
	}
	 ...
	 *
	 * This ambiguous syntax occurs at:
	 *     (rule start) (ambiguity) NEWLINE* graphPolicies+=GraphPolicies
	 */
	protected void emit_Model___NEWLINETerminalRuleCall_0_0_0_a_CommentParserRuleCall_0_0_1__q(EObject semanticObject, ISynNavigable transition, List<INode> nodes) {
		acceptNodes(transition, nodes);
	}
	 ...
	 *
	 * This ambiguous syntax occurs at:
	 *     stopCondition=PercentageCondition ')' (ambiguity) (rule end)
	 *     stopCondition=StringCondition ')' (ambiguity) (rule end)
	 *     stopConditionype=IntegerStopCondition ')' (ambiguity) (rule end)
	 */
	protected void emit_PathGeneratorStopCondition_WSTerminalRuleCall_5_a(EObject semanticObject, ISynNavigable transition, List<INode> nodes) {
		acceptNodes(transition, nodes);
	}

...
public class DSLPoliciesSemanticSequencer extends XbaseSemanticSequencer {
	...
	public void sequence(ISerializationContext context, EObject semanticObject) {
		...
		if (epackage == DSLPoliciesPackage.eINSTANCE)
			switch (semanticObject.eClass().getClassifierID()) {
			case DSLPoliciesPackage.ALGORITHM_TYPE:
				sequence_AlgorithmType(context, (AlgorithmType) semanticObject); 
				return; 
			case DSLPoliciesPackage.GRAPH_ELEMENT:
				sequence_GraphElement(context, (GraphElement) semanticObject); 
				return; 
			case DSLPoliciesPackage.GRAPH_POLICIES:
				sequence_GraphPolicies(context, (GraphPolicies) semanticObject); 
				return; 
			case DSLPoliciesPackage.MODEL:
				sequence_Model(context, (Model) semanticObject); 
				return; 
			case DSLPoliciesPackage.PATH_GENERATOR_STOP_CONDITION:
				sequence_PathGeneratorStopCondition(context, (PathGeneratorStopCondition) semanticObject); 
				return; 
			case DSLPoliciesPackage.POLICIES:
				sequence_Policies(context, (Policies) semanticObject); 
				return; 
			case DSLPoliciesPackage.SEVERITY:
				sequence_Severity(context, (Severity) semanticObject); 
				return; 
			case DSLPoliciesPackage.STOP_CONDITION:
				if (rule == grammarAccess.getIntegerStopConditionRule()) {
					sequence_IntegerStopCondition(context, (StopCondition) semanticObject); 
					return; 
				}
				else if (rule == grammarAccess.getPercentageConditionRule()) {
					sequence_PercentageCondition(context, (StopCondition) semanticObject); 
					return; 
				}
				else if (rule == grammarAccess.getStringConditionRule()) {
					sequence_StringCondition(context, (StopCondition) semanticObject); 
					return; 
				}
				else break;
			}
	...
	/**
	 * Contexts:
	 *     GraphPolicies returns GraphPolicies
	 *
	 * Constraint:
	 *     (graphModelPolicies=ModelName policies+=Policies+)
	 */
	protected void sequence_GraphPolicies(ISerializationContext context, GraphPolicies semanticObject) {
		genericSequencer.createSequence(context, semanticObject);
	}
	...
	/**
	 * Contexts:
	 *     PathGeneratorStopCondition returns PathGeneratorStopCondition
	 *
	 * Constraint:
	 *     (algorithmType=AlgorithmType (stopCondition=StringCondition | stopConditionype=IntegerStopCondition | stopCondition=PercentageCondition))
	 */
	protected void sequence_PathGeneratorStopCondition(ISerializationContext context, PathGeneratorStopCondition semanticObject) {
		genericSequencer.createSequence(context, semanticObject);
	}

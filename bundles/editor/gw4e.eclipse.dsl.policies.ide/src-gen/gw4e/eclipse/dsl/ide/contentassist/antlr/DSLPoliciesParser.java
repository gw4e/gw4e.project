 ...
 */
package gw4e.eclipse.dsl.ide.contentassist.antlr;

import com.google.inject.Inject;
import gw4e.eclipse.dsl.ide.contentassist.antlr.internal.InternalDSLPoliciesParser;
...
public class DSLPoliciesParser extends AbstractContentAssistParser {
	...
	@Override
	protected InternalDSLPoliciesParser createParser() {
		InternalDSLPoliciesParser result = new InternalDSLPoliciesParser(null);
		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getModelNameAccess().getAlternatives(), "rule__ModelName__Alternatives");
					put(grammarAccess.getPoliciesAccess().getAlternatives(), "rule__Policies__Alternatives");
					put(grammarAccess.getPathGeneratorStopConditionAccess().getAlternatives_3(), "rule__PathGeneratorStopCondition__Alternatives_3");
					put(grammarAccess.getAlgorithmTypeAccess().getAlternatives(), "rule__AlgorithmType__Alternatives");
					put(grammarAccess.getIntegerStopConditionAccess().getAlternatives(), "rule__IntegerStopCondition__Alternatives");
					put(grammarAccess.getPercentageConditionAccess().getAlternatives(), "rule__PercentageCondition__Alternatives");
					put(grammarAccess.getStringConditionAccess().getAlternatives(), "rule__StringCondition__Alternatives");
					...
					put(grammarAccess.getGraphPoliciesAccess().getGroup(), "rule__GraphPolicies__Group__0");
					put(grammarAccess.getModelNameAccess().getGroup_0(), "rule__ModelName__Group_0__0");
					...
					put(grammarAccess.getIntegerStopConditionAccess().getGroup_2(), "rule__IntegerStopCondition__Group_2__0");
					put(grammarAccess.getIntegerStopConditionAccess().getGroup_3(), "rule__IntegerStopCondition__Group_3__0");
					put(grammarAccess.getPercentageConditionAccess().getGroup_0(), "rule__PercentageCondition__Group_0__0");
					put(grammarAccess.getPercentageConditionAccess().getGroup_1(), "rule__PercentageCondition__Group_1__0");
					put(grammarAccess.getPercentageConditionAccess().getGroup_2(), "rule__PercentageCondition__Group_2__0");
					put(grammarAccess.getPercentageConditionAccess().getGroup_3(), "rule__PercentageCondition__Group_3__0");
					put(grammarAccess.getPercentageConditionAccess().getGroup_4(), "rule__PercentageCondition__Group_4__0");
					put(grammarAccess.getPercentageConditionAccess().getGroup_5(), "rule__PercentageCondition__Group_5__0");
					put(grammarAccess.getStringConditionAccess().getGroup_0(), "rule__StringCondition__Group_0__0");
					put(grammarAccess.getStringConditionAccess().getGroup_1(), "rule__StringCondition__Group_1__0");
					put(grammarAccess.getStringConditionAccess().getGroup_2(), "rule__StringCondition__Group_2__0");
					put(grammarAccess.getStringConditionAccess().getGroup_3(), "rule__StringCondition__Group_3__0");
					...
					put(grammarAccess.getModelAccess().getGraphPoliciesAssignment_0_1_1(), "rule__Model__GraphPoliciesAssignment_0_1_1");
					put(grammarAccess.getGraphPoliciesAccess().getGraphModelPoliciesAssignment_0(), "rule__GraphPolicies__GraphModelPoliciesAssignment_0");
					put(grammarAccess.getGraphPoliciesAccess().getPoliciesAssignment_2(), "rule__GraphPolicies__PoliciesAssignment_2");
					put(grammarAccess.getSeverityAccess().getLevelAssignment(), "rule__Severity__LevelAssignment");
					...
					put(grammarAccess.getPathGeneratorStopConditionAccess().getStopConditionAssignment_3_2(), "rule__PathGeneratorStopCondition__StopConditionAssignment_3_2");
					...
					put(grammarAccess.getAlgorithmTypeAccess().getTypeAssignment_4(), "rule__AlgorithmType__TypeAssignment_4");
					put(grammarAccess.getAlgorithmTypeAccess().getTypeAssignment_5(), "rule__AlgorithmType__TypeAssignment_5");
					put(grammarAccess.getAlgorithmTypeAccess().getTypeAssignment_6(), "rule__AlgorithmType__TypeAssignment_6");
					put(grammarAccess.getAlgorithmTypeAccess().getTypeAssignment_7(), "rule__AlgorithmType__TypeAssignment_7");
					...
					put(grammarAccess.getIntegerStopConditionAccess().getValueAssignment_1_2(), "rule__IntegerStopCondition__ValueAssignment_1_2");
					put(grammarAccess.getIntegerStopConditionAccess().getPathtypeAssignment_2_0(), "rule__IntegerStopCondition__PathtypeAssignment_2_0");
					put(grammarAccess.getIntegerStopConditionAccess().getValueAssignment_2_2(), "rule__IntegerStopCondition__ValueAssignment_2_2");
					put(grammarAccess.getIntegerStopConditionAccess().getPathtypeAssignment_3_0(), "rule__IntegerStopCondition__PathtypeAssignment_3_0");
					put(grammarAccess.getIntegerStopConditionAccess().getValueAssignment_3_2(), "rule__IntegerStopCondition__ValueAssignment_3_2");
					put(grammarAccess.getPercentageConditionAccess().getPathtypeAssignment_0_0(), "rule__PercentageCondition__PathtypeAssignment_0_0");
					put(grammarAccess.getPercentageConditionAccess().getPercentageAssignment_0_2(), "rule__PercentageCondition__PercentageAssignment_0_2");
					put(grammarAccess.getPercentageConditionAccess().getPathtypeAssignment_1_0(), "rule__PercentageCondition__PathtypeAssignment_1_0");
					put(grammarAccess.getPercentageConditionAccess().getPercentageAssignment_1_2(), "rule__PercentageCondition__PercentageAssignment_1_2");
					put(grammarAccess.getPercentageConditionAccess().getPathtypeAssignment_2_0(), "rule__PercentageCondition__PathtypeAssignment_2_0");
					put(grammarAccess.getPercentageConditionAccess().getPercentageAssignment_2_2(), "rule__PercentageCondition__PercentageAssignment_2_2");
					put(grammarAccess.getPercentageConditionAccess().getPathtypeAssignment_3_0(), "rule__PercentageCondition__PathtypeAssignment_3_0");
					put(grammarAccess.getPercentageConditionAccess().getPercentageAssignment_3_2(), "rule__PercentageCondition__PercentageAssignment_3_2");
					put(grammarAccess.getPercentageConditionAccess().getPathtypeAssignment_4_0(), "rule__PercentageCondition__PathtypeAssignment_4_0");
					put(grammarAccess.getPercentageConditionAccess().getPercentageAssignment_4_2(), "rule__PercentageCondition__PercentageAssignment_4_2");
					put(grammarAccess.getPercentageConditionAccess().getPathtypeAssignment_5_0(), "rule__PercentageCondition__PathtypeAssignment_5_0");
					put(grammarAccess.getPercentageConditionAccess().getPercentageAssignment_5_2(), "rule__PercentageCondition__PercentageAssignment_5_2");
					put(grammarAccess.getStringConditionAccess().getPathtypeAssignment_0_0(), "rule__StringCondition__PathtypeAssignment_0_0");
					put(grammarAccess.getStringConditionAccess().getGraphelementAssignment_0_2(), "rule__StringCondition__GraphelementAssignment_0_2");
					put(grammarAccess.getStringConditionAccess().getPathtypeAssignment_1_0(), "rule__StringCondition__PathtypeAssignment_1_0");
					put(grammarAccess.getStringConditionAccess().getGraphelementAssignment_1_2(), "rule__StringCondition__GraphelementAssignment_1_2");
					put(grammarAccess.getStringConditionAccess().getPathtypeAssignment_2_0(), "rule__StringCondition__PathtypeAssignment_2_0");
					put(grammarAccess.getStringConditionAccess().getGraphelementAssignment_2_2(), "rule__StringCondition__GraphelementAssignment_2_2");
					put(grammarAccess.getStringConditionAccess().getPathtypeAssignment_3_0(), "rule__StringCondition__PathtypeAssignment_3_0");
					put(grammarAccess.getStringConditionAccess().getGraphelementAssignment_3_2(), "rule__StringCondition__GraphelementAssignment_3_2");
					put(grammarAccess.getGraphElementAccess().getNameAssignment(), "rule__GraphElement__NameAssignment");
